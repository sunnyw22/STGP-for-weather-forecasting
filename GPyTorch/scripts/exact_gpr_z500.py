...
def train_gp(lead_time_h, data_train, data_test, space_subsample=1, time_subsample=1, frac=0.1, epochs=5000, save_model=False, device=device):
    ...
    for epoch in tqdm(range(epochs), desc="Training Progress", unit="epoch"):
        ...
        hyperparams_track.append({
            ...
            "spatial_1_lengthscale": spatial_kernel_mod.kernels[0].lengthscale.item(),
            "spatial_2_lengthscale": spatial_kernel_mod.kernels[1].lengthscale.item(),
            "spatial_3_lengthscale": spatial_kernel_mod.kernels[2].lengthscale.item(),
            "time_matern_lengthscale": temporal_kernel_mod.kernels[0].lengthscale.item(),
